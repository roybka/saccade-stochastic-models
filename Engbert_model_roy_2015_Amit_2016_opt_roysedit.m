...
% Adar's code for 2015.
% draft for Roy's trials 
visualize=0;
...
lambda1=1.48%1.48*2;%1.48; %after micro-saccade
lambda2=9.07*0.25; %9.07%after micro-saccade
rho1=5.2^10^-3%0.0052*0.5*0.5;%0.0052; %after micro-saccade
rho2=3.08*10^-3%0.00308*0.5*0.5*0.5; %after micro-saccade
