...
lambda=1;
runs=10;
lambda1=1.48; %after micro-saccade
lambda2=9.07; %after micro-saccade
rho1=0.0052; %after micro-saccade
rho2=0.00308; %after micro-saccade
t_from_last_ms = 0;
...
for iternum=ones(1,runs)*180000
    ...
    for iter=1:iternum
        ...
        %if (H(i,j)*ap_t)>=hc_t % MS triggering mechanism
